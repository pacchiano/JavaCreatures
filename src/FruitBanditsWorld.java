...
public class FruitBanditsWorld {
	...
	public FruitBanditsWorld( int num_fruit_types, double[] fruit_type_probabilities, double[] poison_probabilities		) {
	...
	public int[] get_fruit_type_poison_type() {
